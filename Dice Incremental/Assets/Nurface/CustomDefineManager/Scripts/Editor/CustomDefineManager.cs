...
namespace CustomDefineManagement
{
    public partial class CustomDefineManager : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            foreach (var directive in directives)
            {
                ...
                EditorGUILayout.BeginHorizontal(directiveLineStyle, GUILayout.Height(24), GUILayout.ExpandWidth(true));
                {
                    ...
                    EditorGUILayout.BeginHorizontal(platformsStyles, GUILayout.Height(24), GUILayout.Width(135));
                    {
            ...
            EditorGUILayout.BeginHorizontal(directiveLineStyle, GUILayout.Height(24), GUILayout.ExpandWidth(true));
            {
                ...
                if (GUILayout.Button("Apply", GUILayout.Width(100))) SaveDirectives(directives);

                GUILayout.Space(2);

                if (GUILayout.Button("Revert", GUILayout.Width(100))) Reload();
            }
            EditorGUILayout.EndHorizontal();
        ...
        void RenderTableHeader()
        {
            ...
            EditorGUILayout.LabelField("Platforms", style, GUILayout.Width(135), GUILayout.Height(20));
